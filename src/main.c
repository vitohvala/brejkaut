...
void set_color(SDL_Renderer *renderer, const int color){
    Color c;
    c.color = color;
...
uint8_t collision(SDL_Rect rectball, SDL_Rect rectbar, SDL_Rect *blocks, int *size){
...
uint8_t update(Ball *ball, SDL_Rect bar, SDL_Rect *blocks, int *size){
    uint8_t flag = 1;
